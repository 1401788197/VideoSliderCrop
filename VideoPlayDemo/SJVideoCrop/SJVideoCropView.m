...
//	return CMTimeRangeMake(CMTimeMakeWithSeconds(_mediaConfig.startTime, 600), CMTimeMakeWithSeconds(_mediaConfig.endTime, 600));
//}

//- (CMTime)getStartTime
//{
//	return CMTimeMakeWithSeconds(_mediaConfig.startTime, self.playerLayer.player.currentTime.timescale);
//}
//
